...
var docMostPop = function(doc) {
	emit(doc.abbreviation, { "name": doc.name, "population": doc.population ,"mostPopulousCity":doc.mostPopulousCity});
}
var docShowBooks = function(doc) {
	emit(doc.abbreviation, { "name": doc.name, "author": doc.author ,"ISBN":doc.ISBN});
}
